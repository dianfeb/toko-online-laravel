...
<head>
    ...
    <title>Toko Online Laravel | Login</title>
                ...
                <div class="col-md-6 col-lg-7 bg-light">
                    <div class="hero-wrap d-flex align-items-center h-100">
                        ...
                        <div class="hero-bg hero-bg-scroll"
                            style="background-image:url('../../../assets/images/login-bg-7.jpg');"></div>
                        <div class="hero-content mx-auto w-100 h-100 d-flex flex-column">
                            <div class="container">
                                <div class="row g-0 mt-5">
                                    <div class="col-11 col-md-10 col-lg-9 mx-auto">
                                        <h1 class="text-13 text-white fw-600 mb-4">To keep connected with largest shop
                                            in the world.</h1>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-lg-5 d-flex flex-column align-items-center">
                    <div class="container pt-4">
                        <div class="row g-0">
                            <div class="col-11 col-md-10 col-lg-9 mx-auto">
                                <div class="logo">
                                    <a class="fw-600 text-6 text-dark link-underline link-underline-opacity-0"
                                        href="index.html" title="Oxyy">Toko</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <form id="loginForm" method="POST" action="{{ route('admin.login') }}">
                                    ...
                                    <div class="mb-3 icon-group icon-group-end">
                                        <input type="email" class="form-control bg-light border-light"
                                            id="emailAddress" name="email" required placeholder="Email or Username">
                                    ...
                                    <div class="mb-3 icon-group icon-group-end">
                                        <input type="password"
                                            ...
                                            id="loginPassword" name="password" required placeholder="Password">
