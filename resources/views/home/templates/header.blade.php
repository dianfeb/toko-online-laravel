            ...
            <div class="container container-xxl">
                ...
                <div class="d-block d-xl-none">
                    <nav class="navbar navbar-expand-xl px-0 py-2 py-xl-0 w-100 align-items-center">
                        ...
                        <a href="#search-popup" data-gtf-mfp="true"
                            data-mfp-options="{&quot;type&quot;:&quot;inline&quot;,&quot;focus&quot;: &quot;#keyword&quot;,&quot;mainClass&quot;: &quot;mfp-search-form mfp-move-from-top mfp-align-top&quot;}"
                            class="nav-search d-block py-0" title="Search"><i class="fa fa-search"></i></a>
                    </nav>
                </div>
            </div>
        </div>
        ...
        <div class="container container-xxl">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 mb-6 mb-lg-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="py-0"><a href="#"
                                class="text-gray hover-primary lh-2 font-weight-500">Facebook</a> </li>
                        <li class="py-0"><a href="#"
                                class="text-gray hover-primary lh-2 font-weight-500">Pinterest</a> </li>
                        <li class="py-0"><a href="#"
                                class="text-gray hover-primary lh-2 font-weight-500">Instagram</a> </li>
                        <li class="py-0"><a href="#"
